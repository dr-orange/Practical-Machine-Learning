...
```
Accuracy for Random Forest model was 0.9895. It's a very high accuracy, but we will try another model for confirmation in next section.
...
```
Accuracy for Decision Tree model was 0.7341. It was not good value.
